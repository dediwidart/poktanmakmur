    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <label for="name">Nama</label>
                <input type="text" name="name" class="form-control" value="{{$agenda->name}}" placeholder="Nama Kegiatan" required>
            </div>
            <div class="form-group">
                <label>Tanggal:</label>
                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                    <input type="text" name="date" value="{{$agenda->date}}" placeholder="Tanggal Kegiatan" class="form-control datetimepicker-input" data-target="#reservationdate" required/>
            ...
            <label for="name">Lokasi</label>
                <input type="text" name="location" value="{{$agenda->location}}" class="form-control" placeholder="Lokasi Kegiatan" required>
            </div>
            <div class="row">
            <div class="col-12">
